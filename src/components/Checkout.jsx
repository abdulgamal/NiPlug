          ...
          <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow relative">
            ...
            <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
              <button
                ...
                className="text-white flex items-center justify-center gap-2 bg-[#1d7874] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
                {loading && (
                  <svg
