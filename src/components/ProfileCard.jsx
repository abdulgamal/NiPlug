      ...
      <div className="w-full pb-4">
        ...
        {shop ? (
          <Link
            ...
            className="bg-[#1d7874] text-[#d4af37] px-5 py-1 mb-2 rounded-2xl w-full md:w-auto"
          >
            Go To Link
          </Link>
        ) : (
          <button
            ...
            className="bg-[#1d7874] inline-flex items-center justify-center gap-4 text-[#d4af37] px-5 py-1 rounded-2xl w-full md:w-auto"
          >
            {loading && (
              <svg
