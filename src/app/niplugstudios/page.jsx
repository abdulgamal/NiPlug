      ...
      <section className="bg-[#FBF2B8]" id="contacts">
        <div className="container px-6 py-12 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            ...
            <div className="p-4 py-6 rounded-lg bg-teal-600 md:p-8">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-4">
                  ...
                  <select
                    ...
                    className="block py-2.5 px-0 w-full text-sm text-gray-600 bg-transparent border-0 border-b-2 border-gray-200 appearance-none  focus:outline-none focus:ring-0 focus:border-gray-200 peer"
                  >
